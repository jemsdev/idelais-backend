...
$('.dt-tambah').on('click', function() {
    ...
    if (lang == 'Halal-ID') {
        $('#type').append($('<option>', {value:'Persiapan', text:'Pendampingan Persiapan Sertifikasi Halal'}));
        $('#type').append($('<option>', {value:'Proses', text:'Pendampingan Proses Sertifikasi Halal'}));
        $('#type').append($('<option>', {value:'Pasca', text:'Pendampingan Pasca Sertifikasi Halal'}));   
    } else {
        $('#type').append($('<option>', {value:'Persiapan', text:'Assistance in Preparation of Halal Certification'}));
        $('#type').append($('<option>', {value:'Proses', text:'Assistance in Process of Halal Certification'}));
        $('#type').append($('<option>', {value:'Pasca', text:'Post-Certification Process Support Service'}));   
    }    
});
