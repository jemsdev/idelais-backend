...
$(document).ready(function(){
    ...
    if (url[2] == 'GOAL') {
        document.getElementById("goal").setAttribute("class", "badge badge-dark");
    }else if (url[2] == 'OPEN') {   
        document.getElementById("open").setAttribute("class", "badge badge-dark");
    }else{
        document.getElementById("all").setAttribute("class", "badge badge-dark");
    }
});

$('#optionChart').on('change', function() {
