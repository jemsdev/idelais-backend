            ...
            togglethemeEl.addEventListener('click', function() {
                ...
                if (parseObj.settings.layout.darkMode) {
                    ...
                    if (!getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../template/src/assets/img/logo2.svg')
                        } else {
                    ...
                    if (getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../template/src/assets/img/logo.svg')
                        } else {
